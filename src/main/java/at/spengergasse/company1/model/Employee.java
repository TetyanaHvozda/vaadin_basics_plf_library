        ...
        if (csvString != null) {
            ...
            if (tokens.length >= 9) {
                ...
                try {
                    ...
                    throw new CompanyException("Error: could not read date in line " + csvString + ". ", e);
                }
                switch (tokens[6]) {
                    ...
                    default: throw new CompanyException("Error: invalid role value in line " + csvString + ". ");
                }
                try {
                    int salary = Integer.parseInt(tokens[7]);
                    setSalary(salary);
                } catch (NumberFormatException e) {
                    throw new CompanyException("Error: invalid salary in line " + csvString + ". ", e);
                }
                ...
                if ("Employee".equals(tokens[8])) {
                    ...
                    throw new CompanyException("Error: invalid employment status in line " + csvString + ". Expected: 'Employee' or 'Subcontractor'.");
                }
            } else {
                throw new CompanyException("Error: invalid csv line: " + csvString + ". Not enough values (columns). ");
            }
        } else {
